...
<body class="bg-gray-50 p-4 md:p-8 min-h-screen">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Edit Pengguna: {{ $user->name }}</h1>
        </div>
        ...
        <div class="neumorphic p-6 mb-6">
            <form action="{{ route('admin.users.update', $user) }}" method="POST">
                ...
                <div id="academic-info-section" class="mb-8 @if(!in_array($user->role, ['mahasiswa', 'dosen'])) hidden @endif">
                    <h2 class="text-xl font-semibold mb-4 text-gray-700 border-b pb-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div id="tahun-masuk-field" @if($user->role !== 'mahasiswa') style="display: none;" @endif>
